      ...
      <section className="py-16 bg-[#FF6B00] text-white">
        <div className="section-container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link 
              to="/login" 
              className="bg-[#ffeee3] text-[#2E2E2E] hover:bg-white font-medium px-8 py-4 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 inline-block"
            >
              Post a Custom Job
            </Link>
          </div>
